...
export const UserIcon = ({ width = '20px', height = '20px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const FacebookIcon = ({ width = '20px', height = '20px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MessagesIcon = ({ width = '26px', height = '26px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const NotificationsIcon = ({ width = '32px', height = '32px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const TymIconOutLine = ({ width = '20px', height = '20px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const EditProfileIcon = ({ width = '20px', height = '20px', className }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 20 20"
