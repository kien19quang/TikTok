...
export const HomeIcon = ({ width = '32px', height = '32px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const HomeIconActive = ({ width = '32px', height = '32px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const UserGroupIcon = ({ width = '32px', height = '32px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const UserGroupIconActive = ({ width = '32px', height = '32px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const LiveIcon = ({ width = '32px', height = '32px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const LiveIconActive = ({ width = '32px', height = '32px', className }: IconProps) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const TagIcon = ({ width = '16px', height = '16px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MusicIcon = ({ width = '16px', height = '16px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const TymIcon = ({ width = '24px', height = '24px', className }: IconProps) => (
    <svg
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
...
export const TymIconActive = ({ width = '24px', height = '24px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const CommentIcon = ({ width = '24px', height = '24px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ShareIcon = ({ width = '24px', height = '24px', className }: IconProps) => (
...
export const ShareOutLineIcon = ({ width = '24px', height = '24px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MoreIcon = ({ width = '24px', height = '24px', className }: IconProps) => (
    <svg
        className={className}
        width={width}
        height={height}
